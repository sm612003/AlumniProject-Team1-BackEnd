...
// router.get('/read/blogs', getBlogById);
// // router.get('/:id', findByCategory);
// router.delete('/delete/blogs', deleteBlog);
// router.patch('/update/blogs', updateBlog);
